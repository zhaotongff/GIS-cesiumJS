	...
	render(){
		return(
			<div className='home-main'>
	            ...
	            <p className="text">本项目自2018年7月9日起实施，项目组成员通过多方面调研，对比MapboxGL、Open Layers、CesiumJS、ArcGIS API forJS、SuperMap几款Gis框架，从它们功能、插件丰富程度、可维护性、可扩展性、坐标兼容性、社区支持度、优缺点等方面分析，最终确定利用支持3D技术gis开源前端框架CesiumJS实现，主要完成的功能包括：3D楼宇模型、3D可视化球型图、平面定位缓存、经纬度显示、热力图、人员轨迹控制、飞机轨迹还原等功能。</p>
				</div>
			</div>
		)
	}
